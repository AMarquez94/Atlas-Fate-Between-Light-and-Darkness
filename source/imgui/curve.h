...
namespace ImGui
{
    ...
    int Curve(const char *label, const ImVec2& size, const int maxpoints, ImVec2 *points)
    {
        ...
        const bool hovered = ImGui::IsMouseHoveringRect(bb.Min, bb.Max);// IsHovered(bb, id);
        ...
        RenderTextClipped(ImVec2(bb.Min.x, bb.Min.y + style.FramePadding.y), bb.Max, str, NULL, NULL, ImVec2(0,0));
