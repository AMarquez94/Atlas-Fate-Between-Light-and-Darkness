...
{
public:
	enum EGUIWidgets{ MAIN_MENU_BACKGROUND = 0, MAIN_MENU_BUTTONS, MAIN_MENU_OPTIONS, INGAME_STAMINA_BAR, INGAME_MENU_PAUSE, INGAME_MENU_PAUSE_BUTTONS, SOUND_GRAPH, DEAD_MENU_BUTTONS, DEAD_MENU_BACKGROUND, CONTROLS, BACK_BUTTON, DEAD_BUTTON, LOADING_SPRITE, LOADING_BACKGROUND, BLACK_SCREEN, INGAME_MENU_PAUSE_LINE, CREDITS, CREDITS_BACKGROUND, MAIN_MENU_CONTROLS_BACKGROUND, MAIN_MENU_CONTROLS_BACK, MAIN_MENU_CREDITS_BACKGROUND, MAIN_MENU_CREDITS_BACK, SUBTITLES, SPLASH_SCREEN, DEAD_LINE, INGAME_MENU_PAUSE_MISSION, INGAME_HUD_ENEMY, MAIN_MENU_SCENE, CINEMATIC_INTRO, INGAME_FINAL_DECISION,ATLAS_LAST_SPLASH, ATLAS_LAST_SPLASH_LINE, ATLAS_LAST_SPLASH_SUB, SPLASH_BACKGROUND, SPLASH_UPF, SPLASH_BABYROBOT, SPLASH_SOFTWARE, SPLASH_ENGINE, TIPS_BACK, TIPS_BACKGROUND, DEAD_TIPS };
