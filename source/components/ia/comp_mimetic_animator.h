...
{
public:
	enum EAnimation { IDLE = 0, WALK, DEATH, RUN, DIE, TURN_LEFT, TURN_RIGHT, SUSPECTING, PLAYER_FOUNDED, LOOKING_FOR_PLAYER, ALARM, JUMP_TO_WALL, WALL_WALK, QUIT_WALL, IDLE_WALL};
